...
function Error() {
    return (
        <>
            <div>
                <svg width="380px" height="500px" viewBox="0 0 837 1045" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" sketchType="http://www.bohemiancoding.com/sketch/ns">
                ...
                <div className="message-box">
                    ...
                    <div className="buttons-con">
                        <div className="action-link-wrap">
                            ...
                            <Link to="/"> <a href className="link-button">Go to Home Page</a></Link>
